package com.axiagroups.roomwithkotlin.adapter
...
import com.axiagroups.roomwithkotlin.databinding.ContactsLayoutBinding
import com.axiagroups.roomwithkotlin.databinding.ListaitemContactBinding
...
class ContactsAdapter(val context : Context, val list : List<Contacts>) : RecyclerView.Adapter<ContactsAdapter.ViewHolder>() {
    ...
    class ViewHolder(val binding : ListaitemContactBinding) : RecyclerView.ViewHolder(binding.root){}
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            ListaitemContactBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        )
    }
